    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/percursos/*/duvidas").hasRole("ALUNO")
                        .requestMatchers(HttpMethod.POST, "/percursos/*/duvidas/*/apoios").hasRole("ALUNO")
                        .requestMatchers(HttpMethod.DELETE, "/percursos/*/duvidas/*/apoios").hasRole("ALUNO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/progresso/meu").authenticated()
